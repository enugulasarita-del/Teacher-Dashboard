...
{
    public partial class VacLecturesForm : Form
    {
        ...
        private void btnDeleteLecture_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Are you sure you want to delete this lecture?", "Confirm Delete", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {
                DataGridViewRow selectedRow = dgvVac.SelectedRows[0];
